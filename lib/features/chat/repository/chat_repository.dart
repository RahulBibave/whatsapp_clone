...
class ChatRepository {
  ...
  void sendTextMessage({
    ...
    try {
      ...
      _saveDataToContactsSubcollection(
          senderUser, recievrUserData, text, timeSent, recieverUserId);
  ...
  void sendFileMessage({
    required BuildContext context,
    required File file,
    required String reciverUserIds,
    ...
    try {
      ...
      String imageUrl = await ref
          ...
          .storeFileToFirebase(
              'chat/${messageEnum.type}/${senderUserData.uid}/$reciverUserIds/$messageId',
              file);
      UserModel recieverUserData;
      var userDataMap =
          await firestore.collection('users').doc(reciverUserIds).get();
      ...
      _saveDataToContactsSubcollection(senderUserData, recieverUserData,
          contactMsg, timeSent, reciverUserIds);

      _saveMessageToMessageSubcollection(
          recieverUserId: reciverUserIds,
          text: imageUrl,
          timeSent: timeSent,
          messageId: messageId,
